...
const TOOL_ID = "tool-dev-decision-room-ai";
...
async function main() {
  ...
  await anna.window.set_title({ title: "decision-room-ai" });
  ...
  btn.addEventListener("click", async () => {
    ...
    try {
      ...
      await anna.storage.set({ key: "decision-room-ai:last", value: Date.now() });
